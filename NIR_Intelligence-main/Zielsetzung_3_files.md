Diese drei Dateien bilden zusammen die Governance-Ebene des Systems: [**TASK.md**](http://TASK.md) definiert das Ziel, **task_definition.yaml** die operativen Regeln der Agenten und **system_manifest.json** die technische Architektur und Pflichtkomponenten. Dadurch können CrewAI-Agenten oder ein eigener Master-Agent konsistent initialisiert und gesteuert werden.
