...
ParameterRecommenderAgent is a specialized agent in the NIR Intelligence Platform responsible for ParameterRecommender functionality.
...
ParameterRecommenderAgent requires the following dependencies:
...
ParameterRecommenderAgent handles the following error scenarios:
...
Run tests for ParameterRecommenderAgent:

```bash
# Unit tests
pytest tests/unit/test_parameter_recommender_agent.py

# Integration tests
pytest tests/integration/test_parameter_recommender_agent_integration.py

# End-to-end tests
pytest tests/e2e/test_parameter_recommender_agent_e2e.py
```
