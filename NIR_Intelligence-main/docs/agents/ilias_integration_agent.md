...
ILIASIntegrationAgent is a specialized agent in the NIR Intelligence Platform responsible for ILIASIntegration functionality.
...
ILIASIntegrationAgent requires the following dependencies:
...
```python
from agents.ilias_integration_agent import ILIASIntegrationAgent
...
ILIASIntegrationAgent handles the following error scenarios:
...
Run tests for ILIASIntegrationAgent:

```bash
# Unit tests
pytest tests/unit/test_ilias_integration_agent.py

# Integration tests
pytest tests/integration/test_ilias_integration_agent_integration.py

# End-to-end tests
pytest tests/e2e/test_ilias_integration_agent_e2e.py
```
