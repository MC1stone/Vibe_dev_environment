...
OnboardingAgent is a specialized agent in the NIR Intelligence Platform responsible for Onboarding functionality.
...
OnboardingAgent requires the following dependencies:
...
OnboardingAgent handles the following error scenarios:
...
Run tests for OnboardingAgent:

```bash
# Unit tests
pytest tests/unit/test_onboarding_agent.py

# Integration tests
pytest tests/integration/test_onboarding_agent_integration.py

# End-to-end tests
pytest tests/e2e/test_onboarding_agent_e2e.py
```
