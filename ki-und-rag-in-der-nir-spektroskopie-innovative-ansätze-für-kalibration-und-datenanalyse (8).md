...
Ein Beispiel für die praktische Anwendung der *NIR_Mistral*-Plattform ist der folgende *NIR Spectral Analysis Report*. Dieser Report wurde mit der *NIR_Mistral*-Plattform erstellt und demonstriert, wie die Ergebnisse der *NIR*-Analysen strukturiert und nachvollziehbar präsentiert werden.
...
![NIR Spectral Analysis Report](data:application/pdf;base64,VXBsb2FkZWQgZmlsZSBOSVIgU3BlY3RyYWwgQW5hbHlzaXMgUmVwb3J0X8O8YmVyYXJiZWl0ZXQu
cGRmLiBJdHMgYnl0ZXMgYXJlIG5vdCBzdG9yZWQgaW4gdGhlIGZpbGVzeXN0ZW0uIENhbGwgYHJlYWRf
ZmlsZWAgb24gdGhpcyBwYXRoIHRvIGdldCBpdHMgZXh0cmFjdGVkIHRleHQgY29udGVudC4=)
...
![NIR Spectral Analysis Report](data:application/pdf;base64,)
