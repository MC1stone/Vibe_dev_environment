...
*Quarto Vector Database (QVDB)* ist eine der zentralen Komponenten der *NIR_Mistral*-Plattform und ersetzt die bisher genutzte Weaviate-Datenbank. Als Vektordatenbank ist sie speziell für die Speicherung und Abfrage von *NIR*-Spektren als hochdimensionale Vektoren optimiert.

> Jedes Spektrum wird dabei als Vektor repräsentiert, der die Absorptionswerte über den gesamten Wellenlängenbereich von 380 bis 2500 Nanometer abbildet. Dies ermöglicht eine effiziente Similaritätssuche, bei der ähnliche Spektren basierend auf ihrer Vektorähnlichkeit gefunden werden (Quarto Vector Database, 2024).
